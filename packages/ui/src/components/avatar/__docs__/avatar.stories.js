...
export const Playground = {
  ...
  render: ({ text, ...props }) => /*html*/ `
    ...
    <div class="wrapper">
      <ui-avatar ${props.variant ? `variant="${props.variant}"` : ''}>
        <ui-avatar-image
      ...
      <ui-avatar ${props.variant ? `variant="${props.variant}"` : ''}>
        <ui-avatar-text 
          ${props.hue ? `hue="${props.hue}"` : ''}
          ${props.lightness ? `lightness="${props.lightness}"` : ''}
          ${props.saturation ? `saturation="${props.saturation}"` : ''}
          ${props.size ? `size="${props.size}"` : ''}>
            ${text}
        </ui-avatar-text>
      </ui-avatar>
