...
const Template: Story<Partial<DataSet>> = (_attrs: Partial<DataSet>) => {
  return /*html*/ `
    <ce-alert data-append="mb-4">
      <span class="font-medium">Default alert!</span> Change a few things up and try submitting again.
    </ce-alert>
    <ce-alert data-append="mb-4" data-variant="info">
      <span class="font-medium">Info alert!</span> Change a few things up and try submitting again.
    </ce-alert>
    <ce-alert data-append="mb-4" data-variant="error">
      <span class="font-medium">Danger alert!</span> Change a few things up and try submitting again.
    </ce-alert>
    <ce-alert data-append="mb-4" data-variant="success">
      <span class="font-medium">Success alert!</span> Change a few things up and try submitting again.
    </ce-alert>
    <ce-alert data-append="mb-4" data-variant="contrast">
