...
<Canvas withToolbar={true}>
  <Story
    ...
    {() => /*html*/ `
      ...
      <ui-toast data-type="contrast" data-fixed>
        <i slot="icon">
      ...
      <ui-toast data-type="info" data-fixed>
        <i slot="icon">
      ...
      <ui-toast data-type="success" data-fixed>
        <i slot="icon">
          <svg class="w-8 h-8 flex-none" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              stroke-linecap="round"
      ...
      <ui-toast data-type="error" data-fixed>
        <i slot="icon">
          <svg class="w-8 h-8 flex-none" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            <path
              stroke-linecap="round"
...
<Canvas withToolbar={true}>
  <Story
    ...
    {({ slot, ...props }) => /*html*/ `
    <ui-toast
      ${props.color ? `data-type="${props.color}"` : ''}
      data-fixed>
      ${slot}
    </ui-toast>
  `}
